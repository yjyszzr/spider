...
for i in data:
    ...
    if desc:
        ...
        if i['reward_level'] ==6:
            ...
            sql = "insert into dl_super_lotto_result(term_num,reward_level,reward_num1,reward_price1,creat_time) values({},{},{},'{}',{});".format(
                n, i['reward_level'], i['reward_num1'], i['reward_price1'],
                int(time.time()))
        else:
            i['reward_price1'] = i['reward_price1'].replace(',', '')
            i['reward_price2'] = i['reward_price2'].replace(',', '')
            sql = "insert into dl_super_lotto_result(term_num,reward_level,reward_num1,reward_price1,reward_num2,reward_price2,creat_time) values({},{},{},'{}',{},'{}',{});".format(n,i['reward_level'],i['reward_num1'],i['reward_price1'],i['reward_num2'],i['reward_price2'],int(time.time()))
            print('插入成功>{}'.format(n))
        try:
            cur.execute(sql)
            db.commit()
